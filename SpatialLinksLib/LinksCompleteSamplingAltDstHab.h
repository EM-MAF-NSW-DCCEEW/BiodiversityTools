/*
LinksCompleteSamplingAltDstHab.h - complete sampling Spatial Links implementaion with alt dst habitat using new custom heap
...
#pragma once
#ifndef LINKS_COMPLETE_SAMPLING_ALT_DST_HAB_H
#define LINKS_COMPLETE_SAMPLING_ALT_DST_HAB_H
